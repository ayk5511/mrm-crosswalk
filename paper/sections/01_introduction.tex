...
\begin{itemize}[leftmargin=*]
    \item A twelve-requirement crosswalk of machine-learning model-risk regulation across five binding regimes and two voluntary frameworks (\Cref{tab:crosswalk}), with each cell tied to the citable provision and a marking of whether each requirement is explicit, implicit, partial, or absent in each regime.
