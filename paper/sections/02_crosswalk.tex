...
\midrule
1. Model inventory / identification & \S III & Art.~11, Annex~IV; registration Art.~49 & Principle 1 & n/a & Explicit enterprise inventory w/ metadata & MAP-1 / Annex~A \\
...
4. Versioning / change control & \S V & Art.~12; re-conformity & Principles 2-3 & n/a & Lifecycle (deploy / monitor) & MANAGE / \S 8 \\
...
6. Per-prediction / event logging & \S V (outcomes; partial) & Art.~12; items in Art.~12(3) (biometric) & n/a & \textit{partial} & Monitoring (\textit{partial}) & n/a \\
7. Record retention (duration) & n/a & \textbf{Art.~19 ($\geq$6 months)} & n/a & n/a & Through lifecycle + post-decommission & n/a \\
...
11. Fairness / bias assessment & n/a & Art.~10(2), Art.~15 & n/a & \textbf{Fairness (FEAT; Doc 3A)} & \textit{partial} & MEASURE-2.11 / n/a \\
12. Decommissioning / lifecycle end & \textit{impl.} & \textit{impl.} & Principle 3 & n/a & \textbf{Explicit decommission stage} & MANAGE / \S 8 \\
\bottomrule
\end{tabular}
\end{table}
\end{landscape}
...
\begin{itemize}[leftmargin=*]
    ...
    \item \textbf{Decommissioning (row 12)} is an explicit, dedicated lifecycle stage only in OSFI E-23; PRA SS1/23 reaches it through Principle 3, and elsewhere it is at most implied. A firm with no documented model-retirement process clears SR 11-7 but not OSFI E-23.
\end{itemize}
